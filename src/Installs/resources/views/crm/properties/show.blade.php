...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $property->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Properties", "edit")
                <a href="{{ url(config('crmadmin.adminRoute') . '/properties/'.$property->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access

            @la_access("Properties", "delete")
                {{ Form::open(['route' => [config('crmadmin.adminRoute') . '.properties.destroy', $property->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('crmadmin.adminRoute') . '/properties') }}" data-toggle="tooltip" data-placement="right" title="Back to Properties"><i class="fa fa-chevron-left"></i></a></li>
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
						...
						@la_display($module, 'type_data')
						@la_display($module, 'filter')
						@la_display($module, 'show_colum')

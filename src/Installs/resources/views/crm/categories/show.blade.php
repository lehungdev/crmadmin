...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        ...
        <div class="col-md-1 actions">
            @la_access("Categories", "edit")
                <a href="{{ url(config('crmadmin.adminRoute') . '/categories/'.$category->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access

            @la_access("Categories", "delete")
                {{ Form::open(['route' => [config('crmadmin.adminRoute') . '.categories.destroy', $category->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('crmadmin.adminRoute') . '/categories') }}" data-toggle="tooltip" data-placement="right" title="Back to Categories"><i class="fa fa-chevron-left"></i></a></li>
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
						...
						@la_display($module, 'hierarchy')
						@la_display($module, 'slug')
						@la_display($module, 'image')
						@la_display($module, 'icon')
						@la_display($module, 'property')
						@la_display($module, 'publish')
                    </div>
                </div>
            </div>
        </div>
